...
module.exports.getMars = function Mars() {
    const mars = {
        image: 'https://spaceplace.nasa.gov/all-about-mars/en/VallesMarineris.en.jpg',
...
module.exports.getJupiter = function Jupiter() {
    const jupiter = {
        image:'https://spaceplace.nasa.gov/all-about-jupiter/en/jupiter_great-red-spot-and-southern-hemisphere.en.jpg',
...
module.exports.getPluto = function Pluto() {
    const pluto = {
        image: 'https://spaceplace.nasa.gov/all-about-pluto/en/pluto_new_horizons.en.png',
